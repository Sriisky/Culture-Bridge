# Base recommender
# Simple recommender to read in sample data and make recommendations based on user and item information
...
songs_df = pd.read_csv('songs_genres.csv')
...
# Combine the values together for each dataset
songs['combined_songs'] = songs['song_name'] + ' ' + songs['genre']
cities['population'] = cities['population'].astype(str)
cities['combined_cities'] = cities['city_name'] + ' ' + cities['country'] + ' ' + cities['population']
events['combined_events'] = events['event_name'] + ' ' + events['location'] + ' ' + events['event_type']
universities['combined_unis'] = universities['course_name'] + ' ' + universities['location'] + ' ' + universities['university_name']
