// This file gathers all the data for Zilina and displays it on the Zilina page
...
function ZilinaContent() {
    ...
    return (
        <div className="zilina-container">
            ...
            <div className="content-section">
                <h1>Map of Zilina</h1>
                <p>Explore Zilina through google maps! Clicking on a location allows you to explore it further on the Google Maps website.</p>
                <MapComponent 
                    id="zilinaMap" 
                    lat={49.2194} 
                    lng={18.7408} 
                    zoom={13} 
                    markerPosition={{ lat: 49.203449312, lng: 18.7551393 }} 
                    markerTitle="University of Žilina"/>
            </div>
            <div className="content-section">
